    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-sm-6">
                <ul>
                    <li><a href="javascrip:;">Search Event Venues</a></li>
                    <li><a href="javascrip:;">Find Venue Promotions</a></li>
                    <li><a href="javascrip:;">Explore City Guides</a></li>
                </ul>
            </div>
            <div class="col-lg-3 col-sm-6">
                <ul>
            ...
            <div class="col-lg-3 col-sm-6">
                <ul>
                    <li><a href="javascrip:;">Privacy Policy</a></li>
                    <li><a href="javascrip:;">Terms of Use</a></li>
                    <li><a href="javascrip:;">Advertise with us</a></li>
                </ul>
            </div>
        </div>
    </div>
